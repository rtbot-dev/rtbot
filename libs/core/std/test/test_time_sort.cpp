...
TEST_CASE("TimeSort test increasing") {
  ...
  REQUIRE(emitted.find("out1")->second.at(0).value == 1);
  REQUIRE(emitted.find("out1")->second.at(0).time == 1);

  REQUIRE(emitted.find("out2")->second.at(0).value == 2);
  REQUIRE(emitted.find("out2")->second.at(0).time == 2);
}
...
TEST_CASE("TimeSort test decreasing") {
  ...
  REQUIRE(emitted.find("out1")->second.at(0).value == 2);
  REQUIRE(emitted.find("out1")->second.at(0).time == 2);

  REQUIRE(emitted.find("out2")->second.at(0).value == 1);
  REQUIRE(emitted.find("out2")->second.at(0).time == 1);
}
